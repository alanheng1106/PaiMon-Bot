...
module.exports = {
    ...
    async execute(interaction, bot) {
        ...
        try {
            ...
            let desc = `<:custom_check:1524601509772529665> 已成功刪除 **${deleted.size}** 則訊息`;
            ...
            replyEmbed(Colors.Error, '<:custom_cross:1524603300752785550> 執行失敗', '刪除過程中發生錯誤，請確認機器人擁有 `管理訊息` 的權限。');
        }
    }
};
