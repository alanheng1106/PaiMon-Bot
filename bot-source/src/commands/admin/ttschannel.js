    ...
    async execute(interaction, bot) {
        ...
        if (subcommand === 'set') {
            ...
            const container = new ContainerBuilder()
                ...
                .addTextDisplayComponents(new TextDisplayBuilder().setContent(`<:custom_check:1524601509772529665> 已將 <#${channel.id}> 設為自動語音頻道。\n**語言**：\`${lang}\``));
            ...
            const container = new ContainerBuilder()
                ...
                .addSeparatorComponents(new SeparatorBuilder().setDivider(true))
                .addTextDisplayComponents(new TextDisplayBuilder().setContent('<:custom_check:1524601509772529665> 伺服器已解除綁定自動語音頻道。'));
