...
module.exports = {
    ...
    async execute(interaction, bot) {
        ...
        try {
            ...
            if (seconds === 0) {
                await bot.sendSuccess(interaction, '🚀 慢速模式已關閉', `✅ **#${interaction.channel.name}** 的慢速模式已關閉`, true);
            } else {
                ...
                await bot.sendSuccess(interaction, '🐢 慢速模式已啟用',
                    `✅ **#${interaction.channel.name}** 的慢速模式已設定為 **${label}** 每則訊息`, true);
            }
        } catch (err) {
